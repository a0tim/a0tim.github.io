var _jf = _jf || [];
_jf.push(['p', '28545']);
_jf.push(['_setFont', 'wt011', 'css', '.font_text']);
_jf.push(['_setFont', 'wt064', 'css', '.font_kai ']);
(function(f, q, c, h, e, i, r, d) {
	...
	}, j = /\S+/g, o = /[\t\r\n\f]/g, b = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, g = "".trim, s = g && !g.call("\uFEFF\xA0") ? function(u) {
	...
	k.push(["_eventActived",
	function() {
		p(h);
		m(e)
	}]);
	k.push(["_eventInactived",
	function() {
		p(h);
		m(i)
	}]);
...
})(this, this.document, "className", "jf-loading", "jf-active", "jf-inactive", "//ds.justfont.com/js/stable/v/4.2/id/124300964434"); 